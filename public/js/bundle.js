      ...
      function (require, module, exports) {
        ...
        var displayMap = function displayMap(locations) {
          ...
          var map = new mapboxgl.Map({
            container: 'map',
            // container ID
            style: 'mapbox://styles/rahulsharma0212/cl4mj5b21003i14mqs8mc7upd',
            // style URL
          ...
          locations.forEach(function (loc) {
            ...
            new mapboxgl.Popup({
              ...
              .addTo(map); // Extend map bound to include current location
 ...
 */
    ...
    'index.js': [
      function (require, module, exports) {
        ...
        var _updatingSettings = require('./updatingSettings');
        ...
        if (userDataForm)
          userDataForm.addEventListener('submit', function (e) {
            ...
            var email = document.getElementById('email').value;
            (0, _updatingSettings.updateData)(name, email);
          });
      },
      {
        ...
        './mapbox': 'mapbox.js',
        './login': 'login.js',
        './updatingSettings': 'updatingSettings.js',
      },
    ],
